          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                DrawerTile(icon: Icons.help_outline_rounded, title: 'Help'),
                DrawerTile(icon: Icons.info_outline_rounded, title: 'About us'),
              ],
            ),
          ),
          DrawerTile(
            ...
            function: () {
              ScaffoldMessenger.of(context)
                  .showSnackBar(SnackBar(content: Text("HELLOOOOOOOOOOO")));
            },
          ),
        ]),
      ),
